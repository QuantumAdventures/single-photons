...
plt.plot(t, np.power(estimated_states[:, 0], 2) + np.power(estimated_states[:, 1], 2))
plt.plot(t, np.power(new_states[:, 0], 2) + np.power(new_states[:, 1], 2))
plt.grid()
plt.legend(["Estimated", "Simulated"])
plt.show()

...
import numpy as np
from single_photons import gaussian_dynamics_control
...
nbar_env = 0;                                                          # Environmental    occupation number
...
initial = tensor_product([thermal(nbar_0), vacuum()])               # Initial state for the simulation
t = np.linspace(0, (2*np.pi/omega), int(1e2));                                # Timestamps for simulation
...
#rho_bath = vacuum()                                                         # Total state of the baths is the tensor product of the state of each mode
...
bath_0   = thermal(1000)                                                    # Gaussian state for the first bath
bath_1   = vacuum()                                                         # Gaussian state for the first bath
rho_bath = tensor_product([bath_0, bath_1])                                 # Total state of the baths is the tensor product of the state of each mode


##### Simulation
simulation = gaussian_dynamics_control(A, D, N, initial);                               # Create instance of time evolution of gaussian state
